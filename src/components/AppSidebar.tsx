...
import { Info, Hash, Palette, Eye, Globe, type LucideIcon } from 'lucide-react'
...
export type ViewId = 'about' | 'name' | 'palette' | 'context'
...
const NAV_ITEMS: { id: ViewId; label: string; icon: LucideIcon }[] = [
  ...
  { id: 'palette', label: 'Evaluate a palette',  icon: Palette },
  { id: 'context', label: 'Simultaneous contrast', icon: Eye  },
]
    ...
    <aside className="flex flex-col justify-between shrink-0 h-full overflow-y-auto p-8 w-[360px] bg-void-10 border-r border-void-20">
      ...
      <div className="flex flex-col gap-16 w-full">
        ...
        <div className="flex items-center justify-between w-full">
          <img src="/hexicon.svg" alt="hexicon" className="h-5 w-auto" />
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive && 'bg-void-30 text-pulsar font-medium hover:translate-x-0',
                )}
              >
